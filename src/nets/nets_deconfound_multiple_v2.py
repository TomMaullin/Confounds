...
#     
# ==========================================================================
def nets_deconfound_multiple_v2(y, conf, mode='nets_svd', demean=True, dtype='float64', 
    ...
    # Otherwise, run in serial
        ...
        # Check if the columns are coincident
        if coincident:
            ...
            for block in blocks:
                ...
                nets_deconfound_single(y, conf, columns,
                                       mode=mode, demean=True, dtype=np.float64)
        ...
        # If we're not running in coincident mode
            ...
            for i in idx_y:
                ...
                # Perform deconfounding
                nets_deconfound_single(y, conf, [y.columns[i]],
                                       mode=mode, demean=True, dtype=np.float64)
